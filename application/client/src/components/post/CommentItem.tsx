...
import { isSameCommentForRender } from "@web-speed-hackathon-2026/client/src/utils/render_equals";
...
export const CommentItem = memo(
          ...
          <div className="shrink-0 grow-0 pr-2 sm:pr-4">
            ...
            >
              <img
                ...
                decoding="async"
                loading="lazy"
                src={getSafeProfileImagePath(comment.user.profileImage)}
              />
            </Link>
          </div>
  ...
  (prev, next) => {
    return isSameCommentForRender(prev.comment, next.comment);
  },
);
